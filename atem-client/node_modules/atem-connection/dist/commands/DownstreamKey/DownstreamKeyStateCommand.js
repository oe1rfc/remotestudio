...
class DownstreamKeyStateCommand extends CommandBase_1.DeserializedCommand {
    ...
    applyToState(state) {
        ...
        state.video.downstreamKeyers[this.downstreamKeyerId] = Object.assign(Object.assign({}, state_1.AtemStateUtil.getDownstreamKeyer(state, this.downstreamKeyerId)), this.properties);
