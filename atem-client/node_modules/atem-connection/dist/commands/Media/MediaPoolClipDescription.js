...
class MediaPoolClipDescriptionCommand extends CommandBase_1.DeserializedCommand {
    ...
    applyToState(state) {
        // TODO - validate ids
        state.media.clipPool[this.clipId] = Object.assign(Object.assign({}, this.properties), { frames: state_1.AtemStateUtil.getClip(state, this.clipId).frames // TODO - lengthen/shorten array of frames?
         });
