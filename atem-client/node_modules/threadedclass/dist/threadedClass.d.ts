 ...
 */
export declare function threadedClass<T, TCtor extends new (...args: any) => T>(orgModule: string, orgExport: string, constructorArgs: CtorArgs<TCtor>, config?: ThreadedClassConfig): Promise<ThreadedClass<T>>;
export {};
